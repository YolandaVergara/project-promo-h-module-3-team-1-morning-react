...
function formIcon() {
  ...
  if (linkedinValue) {
    iconLinkedin.classList.remove("items--filter");
  } else {
    iconLinkedin.classList.add("items--filter");
  }

  if (githubValue) {
    iconGithub.classList.remove("items--filter");
  } else {
    iconGithub.classList.add("items--filter");
  }

  if (emailValue) {
    iconEmail.classList.remove("items--filter");
  } else {
    iconEmail.classList.add("items--filter");
  }

  if (telValue) {
    iconTel.classList.remove("items--filter");
  } else {
    iconTel.classList.add("items--filter");
  }
}
